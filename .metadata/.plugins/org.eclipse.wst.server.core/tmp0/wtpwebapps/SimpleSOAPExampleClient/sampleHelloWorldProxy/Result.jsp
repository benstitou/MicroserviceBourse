...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="com.neoxia.webservices.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        com.neoxia.webservices.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
